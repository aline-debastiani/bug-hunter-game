...
import { calcPoints } from "../core/scoring";
...
export default function Mission() {
    ...
    const alreadyAnswered = loadState().answers.some((a) => a.missionId === mission.id);
    ...
    function submit() {
        ...
        const earned = calcPoints({ isCorrect, severity: mission.severity });
    ...
    return(
        <Layout title={`Mission ${mission.id}`}>
            {alreadyAnswered ? (
                ...
                You already answered this mission before. You can still answer again, but your score will increase again.
